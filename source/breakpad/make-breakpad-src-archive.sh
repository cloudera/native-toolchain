...
# releases. This script was taken from the Apache Kudu project at
# https://github.com/apache/kudu/blob/master/thirdparty/scripts/make-breakpad-src-archive.sh
#
